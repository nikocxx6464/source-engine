...
static DynamicResupplyItems_t g_DynamicResupplyAmmoItems[] =
{
	...
	{ "item_gc_energy",				"GC_Energy",	SIZE_AMMO_GC_ENERGY,	0.0f },//TE120
};
...
BEGIN_DATADESC( CItem_DynamicResupply )
	...
	DEFINE_KEYFIELD( m_flDesiredAmmo[10],FIELD_FLOAT, "DesiredAmmoGC_Energy" ),//TE120
...
CItem_DynamicResupply::CItem_DynamicResupply( void )
{
	...
	m_flDesiredAmmo[10] = 0;	// GC Energy//TE120
}
