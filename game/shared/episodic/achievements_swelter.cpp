...
DECLARE_SWELTER_MAP_EVENT_ACHIEVEMENT(ACHIEVEMENT_ACH_SWELTER_AIR, "ACH_SWELTER_AIR", 10);
DECLARE_SWELTER_MAP_EVENT_ACHIEVEMENT_HIDDEN(ACHIEVEMENT_ACH_SWELTER_ARSENAL, "ACH_SWELTER_ARSENAL", 10);
