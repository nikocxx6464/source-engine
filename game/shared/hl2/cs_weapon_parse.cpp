...
void PrepareEquipmentInfo( void )
{
	...
	g_EquipmentInfo[2].SetWeaponPrice( HL2GameRules()->GetBlackMarketPriceForWeapon( WEAPON_KEVLAR ) );
	g_EquipmentInfo[2].SetDefaultPrice( KEVLAR_PRICE );
	g_EquipmentInfo[2].SetPreviousPrice( HL2GameRules()->GetBlackMarketPreviousPriceForWeapon( WEAPON_KEVLAR ) );
	...
	g_EquipmentInfo[1].SetWeaponPrice( HL2GameRules()->GetBlackMarketPriceForWeapon( WEAPON_ASSAULTSUIT ) );
	g_EquipmentInfo[1].SetDefaultPrice( ASSAULTSUIT_PRICE );
	g_EquipmentInfo[1].SetPreviousPrice( HL2GameRules()->GetBlackMarketPreviousPriceForWeapon( WEAPON_ASSAULTSUIT ) );
	...
	g_EquipmentInfo[0].SetWeaponPrice( HL2GameRules()->GetBlackMarketPriceForWeapon( WEAPON_NVG ) );
	g_EquipmentInfo[0].SetPreviousPrice( HL2GameRules()->GetBlackMarketPreviousPriceForWeapon( WEAPON_NVG ) );
...
void CCSWeaponInfo::Parse( KeyValues *pKeyValuesData, const char *szWeaponName )
{
	...
	if ( HL2GameRules()->IsBlackMarket() )
	{
		int iWeaponID = ClassnameToWeaponID( GetTranslatedWeaponAlias ( szWeaponName ) );

		m_iDefaultPrice = m_iWeaponPrice;
		m_iPreviousPrice = HL2GameRules()->GetBlackMarketPreviousPriceForWeapon( iWeaponID );
		m_iWeaponPrice = HL2GameRules()->GetBlackMarketPriceForWeapon( iWeaponID );
	}
