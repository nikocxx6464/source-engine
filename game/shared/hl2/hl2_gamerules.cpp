...
//TE120--
ConVar	sk_plr_dmg_gc_energy	( "sk_plr_dmg_gc_energy", "0", FCVAR_REPLICATED);
ConVar	sk_npc_dmg_gc_energy	( "sk_npc_dmg_gc_energy", "0", FCVAR_REPLICATED);
ConVar	sk_max_gc_energy	( "sk_max_gc_energy", "75", FCVAR_REPLICATED);
//TE120--
#ifdef HL2_EPISODIC
...
//		def.AddAmmoType("Extinguisher",		DMG_BURN,					TRACER_NONE,			0,	0, 100, 0, 0 );
		...
		def.AddAmmoType("GC_Energy",		DMG_BULLET,					TRACER_LINE,			"sk_plr_dmg_gc_energy",		"sk_npc_dmg_gc_energy",		"sk_max_gc_energy",		0, 0 );//TE120
