...
COptionsSubVideo::COptionsSubVideo(vgui::Panel *parent) : PropertyPage(parent, NULL)
{
	...
	m_pHUDAspectRatio = new ComboBox( this, "HudAspectRatio", 6, false );
	m_pHUDAspectRatio->AddItem( "#GameUI_HUDAspectRatio_FitDisplay", NULL );
...
//	m_pHDContent = new CheckButton( this, "HDContentButton", "#GameUI_HDContent" );
	...
	m_pHUDAspectRatio->SetEnabled(false);
