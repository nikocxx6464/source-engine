...
./waf configure -T release --build-game=hl2_alonemod --prefix=srceng-mod-launcher/android --android=aarch64,host,21 --target=../aarch64 --enable-opus --togles --disable-warns &&
